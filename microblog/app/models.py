...
class User(UserMixin, db.Model): #database model for Users
 ...
 def set_password(self, password): #for password hashing
  self.password_hash = generate_password_hash(password)

 def check_password(self, password): #for password verification
  return check_password_hash(self.password_hash, password)

 def __repr__(self): #defines the form in which the data is displayed
